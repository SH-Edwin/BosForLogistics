...
public class Constants {
	...
	public static final String CRM_MANAGEMENT_HOST = "http://localhost:9006";
	...
	public static final String CRM_MANAGEMENT_SERVICE = CRM_MANAGEMENT_HOST + CRM_MANAGEMENT_CONTEXT + "/services/customerService";
	public static final String BOS_MANAGEMENT_SERVICE = BOS_MANAGEMENT_HOST + BOS_MANAGEMENT_CONTEXT + "/services";
}
